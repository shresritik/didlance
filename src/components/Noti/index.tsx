...
//         body: JSON.stringify({
//           sui_address: suiAddress.toLowerCase(),
//           subscription,
//         }),
//       });
...
//         `/api/notifications/get?sui_address=${suiAddress.toLowerCase()}`
//       );
//       if (!response.ok) {
...
//           {unreadCount > 0 && (
//             <Badge className="absolute -top-2 -right-2 h-5 w-5 flex items-center justify-center bg-red-500 text-white border-2 border-white rounded-full">
//               {unreadCount}
//             </Badge>
//           )}
//         </button>
