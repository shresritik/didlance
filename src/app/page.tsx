      ...
      >
        <div className="bg-white/50 backdrop-blur-sm rounded-3xl p-12 shadow-lg">
          ...
          <p className="text-2xl text-gray-800 mb-12 max-w-3xl mx-auto leading-relaxed">
            Revolutionizing freelancing with instant, reliable, and portfolio-free opportunities
            in the new economy of micro gigs.
          </p>
          <motion.div
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-lg text-gray-600">Start your journey in the new economy</p>
          </div>
          {wallet.connected ? (
